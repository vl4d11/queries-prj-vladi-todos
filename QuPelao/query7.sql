...
-- datos auxiliares:
update t set fec_programada = '26/05/2025', fec_iniciovacacion = '26/05/2025', fec_finvacacion = '30/05/2025'
from #tmp001_rpta t where cod_trabajador = 'RMR148'
select*into #tmp001_aux from #tmp001_rpta t where cod_trabajador = 'RMR148'
update t set fec_programada = '12/08/2025', fec_iniciovacacion = '12/08/2025', fec_finvacacion = '22/08/2025'
from #tmp001_aux t
insert into #tmp001_rpta select*from #tmp001_aux


update t set fec_programada = '26/05/2025', fec_iniciovacacion = '26/05/2025', fec_finvacacion = '30/05/2025'
from #tmp001_rpta t where cod_trabajador = 'AZA161'
select*into #tmp002_aux from #tmp001_rpta t where cod_trabajador = 'AZA161'
update t set fec_programada = '12/08/2025', fec_iniciovacacion = '12/08/2025', fec_finvacacion = '22/08/2025'
from #tmp002_aux t
insert into #tmp001_rpta select*from #tmp002_aux
